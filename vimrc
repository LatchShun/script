...
set rtp+=~/Project/self/vimconfig/bundle/Vundle.vim
...
nmap  <leader>ev :e $HOME/Project/self/vimconfig/vimrc<CR>
nmap  <leader>sv :so $HOME/Project/self/vimconfig/vimrc<CR>
